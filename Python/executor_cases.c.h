...
#define TIER_TWO 2
        ...
        case _BINARY_OP_MULTIPLY_FLOAT__NO_DECREF_INPUTS_r10: {
            CHECK_CURRENT_CACHED_VALUES(1);
            _PyStackRef right;
            _PyStackRef left;
            _PyStackRef res;
        ...
        case _BINARY_OP_ADD_FLOAT__NO_DECREF_INPUTS_r10: {
            CHECK_CURRENT_CACHED_VALUES(1);
            _PyStackRef right;
            _PyStackRef left;
            _PyStackRef res;
        ...
        case _BINARY_OP_SUBTRACT_FLOAT__NO_DECREF_INPUTS_r10: {
            CHECK_CURRENT_CACHED_VALUES(1);
            _PyStackRef right;
            _PyStackRef left;
            _PyStackRef res;
