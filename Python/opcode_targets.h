...
Py_PRESERVE_NONE_CC static PyObject *_TAIL_CALL_THROW_CONTINUATION(TAIL_CALL_PARAMS);
...
static py_tail_call_funcptr INSTRUCTION_TABLE[256] = {
    ...
    [THROW_CONTINUATION] = _TAIL_CALL_THROW_CONTINUATION,
