...
const struct opcode_metadata _PyOpcode_opcode_metadata[268] = {
    ...
    [CALL] = { true, INSTR_FMT_IBC00, HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG },
    ...
    [CALL_BUILTIN_CLASS] = { true, INSTR_FMT_IBC00, HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
    ...
    [CALL_FUNCTION_EX] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG },
    ...
    [CALL_KW] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG },
    ...
    [PERIODIC] = { true, INSTR_FMT_IX, HAS_EVAL_BREAK_FLAG },
    [PERIODIC_CHECK] = { true, INSTR_FMT_IX, HAS_DEOPT_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [PERIODIC_CHECK] = { .nuops = 1, .uops = { { _PERIODIC_CHECK, 0, 0 } } },
