...
int _PyOpcode_num_popped(int opcode, int oparg)  {
    switch(opcode) {
        ...
        case CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS:
            return 2 + oparg;
        case CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_METHOD:
            return 2 + oparg;
...
const struct opcode_metadata _PyOpcode_opcode_metadata[268] = {
    ...
    [CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_METHOD] = { true, INSTR_FMT_IBC00, HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_METHOD] = { .nuops = 2, .uops = { { _CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_METHOD, 0, 0 }, { _CHECK_PERIODIC, 0, 0 } } },
...
const char *_PyOpcode_OpName[268] = {
    ...
    [CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_METHOD] = "CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_METHOD",
...
const uint8_t _PyOpcode_Deopt[256] = {
    ...
    [CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_METHOD] = CALL,
