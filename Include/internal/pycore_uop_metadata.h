...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_INIT_CALL_PY_EXACT_ARGS_05] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_INIT_CALL_PY_EXACT_ARGS_06] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_INIT_CALL_PY_EXACT_ARGS_07] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_INIT_CALL_PY_EXACT_ARGS_08] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_INIT_CALL_PY_EXACT_ARGS_09] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    ...
    [_COPY_00] = HAS_PURE_FLAG,
    [_COPY_01] = HAS_PURE_FLAG,
    [_COPY_02] = HAS_PURE_FLAG,
    [_COPY_03] = HAS_PURE_FLAG,
    [_COPY_04] = HAS_PURE_FLAG,
    [_COPY_05] = HAS_PURE_FLAG,
    [_COPY_06] = HAS_PURE_FLAG,
    [_COPY_07] = HAS_PURE_FLAG,
    [_COPY_08] = HAS_PURE_FLAG,
    [_COPY_09] = HAS_PURE_FLAG,
    [_COPY] = HAS_ARG_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP] = HAS_ARG_FLAG | HAS_ERROR_FLAG,
    [_SWAP_00] = HAS_PURE_FLAG,
    [_SWAP_01] = HAS_PURE_FLAG,
    [_SWAP_02] = HAS_PURE_FLAG,
    [_SWAP_03] = HAS_PURE_FLAG,
    [_SWAP_04] = HAS_PURE_FLAG,
    [_SWAP_05] = HAS_PURE_FLAG,
    [_SWAP_06] = HAS_PURE_FLAG,
    [_SWAP_07] = HAS_PURE_FLAG,
    [_SWAP_08] = HAS_PURE_FLAG,
    [_SWAP_09] = HAS_PURE_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_INIT_CALL_PY_EXACT_ARGS_05] = "_INIT_CALL_PY_EXACT_ARGS_05",
    [_INIT_CALL_PY_EXACT_ARGS_06] = "_INIT_CALL_PY_EXACT_ARGS_06",
    [_INIT_CALL_PY_EXACT_ARGS_07] = "_INIT_CALL_PY_EXACT_ARGS_07",
    [_INIT_CALL_PY_EXACT_ARGS_08] = "_INIT_CALL_PY_EXACT_ARGS_08",
    [_INIT_CALL_PY_EXACT_ARGS_09] = "_INIT_CALL_PY_EXACT_ARGS_09",
