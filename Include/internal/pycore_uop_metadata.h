...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_GUARD_TOS_INT] = HAS_DEOPT_FLAG,
    [_GUARD_NOS_INT] = HAS_DEOPT_FLAG,
    ...
    [_GUARD_TOS_FLOAT] = HAS_DEOPT_FLAG,
    [_GUARD_NOS_FLOAT] = HAS_DEOPT_FLAG,
    ...
    [_LOAD_INLINE_CONST] = 0,
    [_LOAD_INLINE_IMMORTAL_CONST] = 0,
};
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_LOAD_INLINE_CONST] = "_LOAD_INLINE_CONST",
    [_LOAD_INLINE_IMMORTAL_CONST] = "_LOAD_INLINE_IMMORTAL_CONST",
