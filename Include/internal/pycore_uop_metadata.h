...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_METHOD] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_METHOD] = "_CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_METHOD",
...
int _PyUop_num_popped(int opcode, int oparg)
{
    switch(opcode) {
        ...
        case _CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS:
            return 2 + oparg;
        case _CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_METHOD:
            return 2 + oparg;
