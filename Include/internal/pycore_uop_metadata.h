...
const _PyUopCachingInfo _PyUop_Caching[MAX_UOP_ID+1] = {
    ...
    [_GUARD_NOS_OVERFLOWED] = { 0, 3, 0, { _GUARD_NOS_OVERFLOWED_r00, _GUARD_NOS_OVERFLOWED_r11, _GUARD_NOS_OVERFLOWED_r22, _GUARD_NOS_OVERFLOWED_r33 } },
    [_GUARD_TOS_OVERFLOWED] = { 0, 3, 0, { _GUARD_TOS_OVERFLOWED_r00, _GUARD_TOS_OVERFLOWED_r11, _GUARD_TOS_OVERFLOWED_r22, _GUARD_TOS_OVERFLOWED_r33 } },
    [_BINARY_OP_MULTIPLY_INT] = { 1, 1, 0, { 0, _BINARY_OP_MULTIPLY_INT_r11, 0, 0 } },
    [_BINARY_OP_ADD_INT] = { 1, 1, 0, { 0, _BINARY_OP_ADD_INT_r11, 0, 0 } },
    [_BINARY_OP_SUBTRACT_INT] = { 1, 1, 0, { 0, _BINARY_OP_SUBTRACT_INT_r11, 0, 0 } },
    ...
    [_BINARY_OP_MULTIPLY_FLOAT__NO_DECREF_INPUTS] = { 1, 3, -1, { 0, _BINARY_OP_MULTIPLY_FLOAT__NO_DECREF_INPUTS_r10, _BINARY_OP_MULTIPLY_FLOAT__NO_DECREF_INPUTS_r21, _BINARY_OP_MULTIPLY_FLOAT__NO_DECREF_INPUTS_r32 } },
    [_BINARY_OP_ADD_FLOAT__NO_DECREF_INPUTS] = { 1, 3, -1, { 0, _BINARY_OP_ADD_FLOAT__NO_DECREF_INPUTS_r10, _BINARY_OP_ADD_FLOAT__NO_DECREF_INPUTS_r21, _BINARY_OP_ADD_FLOAT__NO_DECREF_INPUTS_r32 } },
    [_BINARY_OP_SUBTRACT_FLOAT__NO_DECREF_INPUTS] = { 1, 3, -1, { 0, _BINARY_OP_SUBTRACT_FLOAT__NO_DECREF_INPUTS_r10, _BINARY_OP_SUBTRACT_FLOAT__NO_DECREF_INPUTS_r21, _BINARY_OP_SUBTRACT_FLOAT__NO_DECREF_INPUTS_r32 } },
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_BINARY_OP_MULTIPLY_FLOAT__NO_DECREF_INPUTS_r10] = _BINARY_OP_MULTIPLY_FLOAT__NO_DECREF_INPUTS,
    ...
    [_BINARY_OP_ADD_FLOAT__NO_DECREF_INPUTS_r10] = _BINARY_OP_ADD_FLOAT__NO_DECREF_INPUTS,
    ...
    [_BINARY_OP_SUBTRACT_FLOAT__NO_DECREF_INPUTS_r10] = _BINARY_OP_SUBTRACT_FLOAT__NO_DECREF_INPUTS,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_BINARY_OP_ADD_FLOAT__NO_DECREF_INPUTS_r10] = "_BINARY_OP_ADD_FLOAT__NO_DECREF_INPUTS_r10",
    ...
    [_BINARY_OP_MULTIPLY_FLOAT__NO_DECREF_INPUTS_r10] = "_BINARY_OP_MULTIPLY_FLOAT__NO_DECREF_INPUTS_r10",
    ...
    [_BINARY_OP_SUBTRACT_FLOAT__NO_DECREF_INPUTS_r10] = "_BINARY_OP_SUBTRACT_FLOAT__NO_DECREF_INPUTS_r10",
