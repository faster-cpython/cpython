...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_MULTIPLY_FLOAT__NO_DECREF_INPUTS] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_ADD_FLOAT__NO_DECREF_INPUTS] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_SUBTRACT_FLOAT__NO_DECREF_INPUTS] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
...
const _PyUopCachingInfo _PyUop_Caching[MAX_UOP_ID+1] = {
    ...
    [_TO_BOOL_INT] = { 0, 3, 0, 1, { _TO_BOOL_INT_r00, _TO_BOOL_INT_r11, _TO_BOOL_INT_r22, _TO_BOOL_INT_r33 } },
    ...
    [_BINARY_OP_MULTIPLY_INT] = { 1, 3, -1, 0, { 0, _BINARY_OP_MULTIPLY_INT_r10, _BINARY_OP_MULTIPLY_INT_r21, _BINARY_OP_MULTIPLY_INT_r32 } },
    [_BINARY_OP_ADD_INT] = { 1, 3, -1, 0, { 0, _BINARY_OP_ADD_INT_r10, _BINARY_OP_ADD_INT_r21, _BINARY_OP_ADD_INT_r32 } },
    [_BINARY_OP_SUBTRACT_INT] = { 1, 3, -1, 0, { 0, _BINARY_OP_SUBTRACT_INT_r10, _BINARY_OP_SUBTRACT_INT_r21, _BINARY_OP_SUBTRACT_INT_r32 } },
    ...
    [_BINARY_OP_MULTIPLY_FLOAT__NO_DECREF_INPUTS] = { 0, 0, 1, 0, { _BINARY_OP_MULTIPLY_FLOAT__NO_DECREF_INPUTS_r01, 0, 0, 0 } },
    [_BINARY_OP_ADD_FLOAT__NO_DECREF_INPUTS] = { 0, 0, 1, 0, { _BINARY_OP_ADD_FLOAT__NO_DECREF_INPUTS_r01, 0, 0, 0 } },
    [_BINARY_OP_SUBTRACT_FLOAT__NO_DECREF_INPUTS] = { 0, 0, 1, 0, { _BINARY_OP_SUBTRACT_FLOAT__NO_DECREF_INPUTS_r01, 0, 0, 0 } },
    ...
    [_COMPARE_OP_INT] = { 1, 3, -1, 0, { 0, _COMPARE_OP_INT_r10, _COMPARE_OP_INT_r21, _COMPARE_OP_INT_r32 } },
    ...
    [_PUSH_EXC_INFO] = { 0, 0, 2, 0, { _PUSH_EXC_INFO_r02, 0, 0, 0 } },
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_TO_BOOL_INT_r00] = _TO_BOOL_INT,
    [_TO_BOOL_INT_r22] = _TO_BOOL_INT,
    [_TO_BOOL_INT_r33] = _TO_BOOL_INT,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_TO_BOOL_INT_r00] = "_TO_BOOL_INT_r00",
    [_TO_BOOL_INT_r22] = "_TO_BOOL_INT_r22",
    [_TO_BOOL_INT_r33] = "_TO_BOOL_INT_r33",
