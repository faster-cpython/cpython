...
const _PyUopCachingInfo _PyUop_Caching[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_SUBSCR_LIST_INT] = { 1, 1, 0, { 0, _BINARY_OP_SUBSCR_LIST_INT_r11, 0, 0 } },
    ...
    [_LOAD_SUPER_ATTR_ATTR] = { 1, 1, 0, { 0, _LOAD_SUPER_ATTR_ATTR_r11, 0, 0 } },
    [_LOAD_SUPER_ATTR_METHOD] = { 2, 2, 0, { 0, 0, _LOAD_SUPER_ATTR_METHOD_r22, 0 } },
    ...
    [_FOR_ITER_TIER_TWO] = { 0, 0, 0, { _FOR_ITER_TIER_TWO_r00, 0, 0, 0 } },
    ...
    [_ITER_NEXT_LIST_TIER_TWO] = { 0, 0, 0, { _ITER_NEXT_LIST_TIER_TWO_r00, 0, 0, 0 } },
    ...
    [_CALL_BUILTIN_CLASS] = { 0, 0, 0, { _CALL_BUILTIN_CLASS_r00, 0, 0, 0 } },
    [_CALL_BUILTIN_O] = { 0, 0, 0, { _CALL_BUILTIN_O_r00, 0, 0, 0 } },
    [_CALL_BUILTIN_FAST] = { 0, 0, 0, { _CALL_BUILTIN_FAST_r00, 0, 0, 0 } },
    [_CALL_BUILTIN_FAST_WITH_KEYWORDS] = { 0, 0, 0, { _CALL_BUILTIN_FAST_WITH_KEYWORDS_r00, 0, 0, 0 } },
    ...
    [_CALL_METHOD_DESCRIPTOR_O] = { 0, 0, 0, { _CALL_METHOD_DESCRIPTOR_O_r00, 0, 0, 0 } },
    [_CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS] = { 0, 0, 0, { _CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_r00, 0, 0, 0 } },
    [_CALL_METHOD_DESCRIPTOR_NOARGS] = { 0, 0, 0, { _CALL_METHOD_DESCRIPTOR_NOARGS_r00, 0, 0, 0 } },
    [_CALL_METHOD_DESCRIPTOR_FAST] = { 0, 0, 0, { _CALL_METHOD_DESCRIPTOR_FAST_r00, 0, 0, 0 } },
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_BINARY_OP_SUBSCR_LIST_INT_r11] = _BINARY_OP_SUBSCR_LIST_INT,
    ...
    [_LOAD_SUPER_ATTR_ATTR_r11] = _LOAD_SUPER_ATTR_ATTR,
    [_LOAD_SUPER_ATTR_METHOD_r22] = _LOAD_SUPER_ATTR_METHOD,
    ...
    [_FOR_ITER_TIER_TWO_r00] = _FOR_ITER_TIER_TWO,
    ...
    [_CALL_BUILTIN_O_r00] = _CALL_BUILTIN_O,
    ...
    [_CALL_METHOD_DESCRIPTOR_O_r00] = _CALL_METHOD_DESCRIPTOR_O,
    [_CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_r00] = _CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS,
    [_CALL_METHOD_DESCRIPTOR_NOARGS_r00] = _CALL_METHOD_DESCRIPTOR_NOARGS,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_BINARY_OP_SUBSCR_LIST_INT_r11] = "_BINARY_OP_SUBSCR_LIST_INT_r11",
    ...
    [_CALL_BUILTIN_O_r00] = "_CALL_BUILTIN_O_r00",
    ...
    [_CALL_METHOD_DESCRIPTOR_NOARGS_r00] = "_CALL_METHOD_DESCRIPTOR_NOARGS_r00",
    [_CALL_METHOD_DESCRIPTOR_O] = "_CALL_METHOD_DESCRIPTOR_O",
    [_CALL_METHOD_DESCRIPTOR_O_r00] = "_CALL_METHOD_DESCRIPTOR_O_r00",
    ...
    [_FOR_ITER_TIER_TWO_r00] = "_FOR_ITER_TIER_TWO_r00",
    ...
    [_ITER_NEXT_LIST_TIER_TWO_r00] = "_ITER_NEXT_LIST_TIER_TWO_r00",
    ...
    [_LOAD_SUPER_ATTR_ATTR_r11] = "_LOAD_SUPER_ATTR_ATTR_r11",
    [_LOAD_SUPER_ATTR_METHOD] = "_LOAD_SUPER_ATTR_METHOD",
    [_LOAD_SUPER_ATTR_METHOD_r22] = "_LOAD_SUPER_ATTR_METHOD_r22",
