...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_BINARY_SUBSCR_INIT_CALL] = HAS_ESCAPES_FLAG,
    ...
    [_GUARD_TYPE_VERSION] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_CHECK_MANAGED_OBJECT_HAS_VALUES] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_GUARD_DORV_NO_DICT] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_ITER_CHECK_LIST] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_GUARD_NOT_EXHAUSTED_LIST] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_ITER_NEXT_LIST] = HAS_ESCAPES_FLAG,
    [_ITER_CHECK_TUPLE] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_GUARD_NOT_EXHAUSTED_TUPLE] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_ITER_NEXT_TUPLE] = HAS_ESCAPES_FLAG,
    [_ITER_CHECK_RANGE] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_GUARD_NOT_EXHAUSTED_RANGE] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_PUSH_EXC_INFO] = 0,
    [_GUARD_DORV_VALUES_INST_ATTR_FROM_DICT] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_GUARD_KEYS_VERSION] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_CHECK_IS_NOT_PY_CALLABLE] = HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
