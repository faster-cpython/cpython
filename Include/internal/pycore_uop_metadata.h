...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_MULTIPLY_FLOAT_L1] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_MULTIPLY_FLOAT_R1] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_MULTIPLY_FLOAT] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_MULTIPLY_FLOAT_L1] = "_BINARY_OP_MULTIPLY_FLOAT_L1",
    [_BINARY_OP_MULTIPLY_FLOAT_R1] = "_BINARY_OP_MULTIPLY_FLOAT_R1",
