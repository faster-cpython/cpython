...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_GUARD_TOS_INT] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_GUARD_NOS_INT] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    ...
    [_GUARD_TOS_FLOAT] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_GUARD_NOS_FLOAT] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
